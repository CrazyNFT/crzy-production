...
const BorderLinearProgress = withStyles((theme) => ({
  ...
  colorPrimary: {
    backgroundColor: theme.palette.grey[theme.palette.type === 'light' ? '#006F6F' : 700],
  },
  bar: {
    borderRadius: '100px',
...
export default function MarketPlace(props: any) {
  ...
  return (
    <Container>
      ...
      <Container>
        <Typography
          className={classes.formMainHeader}
        >Create a new item</Typography>
        <Typography
          className={classes.formParas}
        >Choose “Single” if you want your collectible to be one of a kind or “Multiple” if you want to sell one collectible multiple times</Typography>
        ...
        <Typography
          className={classes.formParas}
        >CrazyNFT will include a link to this URL on this item's detail page, so that users can click to learn more about it. You are welcome to link to your own webpage with more details.</Typography>
        <TextField
          id="outlined-basic"
          fullWidth
          label="Paste URL"
        ...
        <Typography
          className={classes.formParas}
        >The more the royalty percentage, higher are the chances of your item to be placed on the top of the marketplace list.</Typography>
        <div className={classes.progressDiv}>
          <Button
            value={10}
            onClick={DecrementRoyalty}
            variant="outlined">
            {"-"}
          </Button>
